      ...
      <div className="rounded-lg border p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            {accountPhone && (
              <a href={`tel:${accountPhone}`} className="text-sm text-muted-foreground flex items-center gap-1.5 hover:text-foreground transition-colors">
                <Phone className="h-3 w-3" />
                {accountPhone}
              </a>
            )}
            {accountEmail && (
              <a href={`mailto:${accountEmail}`} className="text-sm text-muted-foreground flex items-center gap-1.5 hover:text-foreground transition-colors">
